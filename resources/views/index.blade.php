    ...
    <section class="about-upper-section" itemprop="mainContentofPage">
        <div class="container">
            ...
            <article class="who-we-are">
                <h2 class="top-heading">IdPlay Sektor Jombang</h2>
                <p> Pada tahun 2021 PT Trans Indonesia Superkoridor regional Jawa Timur 
                    menggelar jaringan innercity FTTH cluster Dusun Gerbong, Desa Sambirejo,
                    Kec. Jogoroto  Jombang dengan bentang kabel 2 km. 
                    Atas tingginya antusias dan permintaan pada tanggal 20 November 2022 
                    PT TIS regional Jawa Timur menyelesaikan   penggelaran jaringan  innercity FTTH 
                    sekala besar di Kec. Jogoroto, dan Jombang kota sekaligus peresmian kantor IDPlay Sektor Jombang.</p>
